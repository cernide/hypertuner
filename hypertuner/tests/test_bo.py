...
from hypertuner.search_managers.bayesian_optimization.optimizer import BOOptimizer
from hypertuner.search_managers.bayesian_optimization.space import SearchSpace
...
class TestBayesSearchManager(BaseTestCase):
    ...
    def test_space_search(self):
        ...
        assert len(
            space1.categorical_features) == 0  # pylint:disable=len-as-condition
    ...
    def test_optimizer_get_suggestion(self):
        ...
        metrics = [0, 1.1, 0.1, 0.1, 1.09, 0.4,
                   100, 200, 200, 300, 110, 210, 210, 310]
